...
class Bar {
    ...
    Bar(Context ctx,
        ...
        mPaint.setPathEffect(new CornerPathEffect(lineRadius) );   // set the path effect when they join.
        mPaint.setAntiAlias(true);

        mLeftRightMargin=leftRightMargin;
    }
...
//        path.moveTo(mLeftX-mLeftRightMargin+lineRadius*2, mY);
//
//        path.lineTo(mRightX+mLeftRightMargin-lineRadius, mY);
        
     
        path.moveTo(mLeftX-mLeftRightMargin+lineRadius, mY);

        path.lineTo(mRightX+mLeftRightMargin, mY);
        

        
//        path.moveTo(mLeftX, mY);
//
//        path.lineTo(mRightX, mY);
