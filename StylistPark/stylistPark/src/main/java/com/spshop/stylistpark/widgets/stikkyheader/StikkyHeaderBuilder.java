package com.spshop.stylistpark.widgets.stikkyheader;
...
public abstract class StikkyHeaderBuilder {
    ...
    public StikkyHeaderBuilder setHeader(final int idHeader, final ViewGroup view) {
    ...
    public StikkyHeaderBuilder setOnLoadListener(final OnLoadMoreListener loadMore) {
    	mLoadMore = loadMore;
    	return this;
    }
    ...
    public static class ListViewBuilder extends StikkyHeaderBuilder {
        ...
        public void removeHeaderView(final View header){
