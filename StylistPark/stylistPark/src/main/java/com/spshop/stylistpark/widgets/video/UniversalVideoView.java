package com.spshop.stylistpark.widgets.video;
                ...
                public  boolean onInfo(MediaPlayer mp, int what, int extra){
                    ...
                    switch (what) {
                        case MediaPlayer.MEDIA_INFO_BUFFERING_START:
                            LogUtil.i(TAG, "onInfo MediaPlayer.MEDIA_INFO_BUFFERING_START");
                            if (videoViewCallback != null) {
                        ...
                        case MediaPlayer.MEDIA_INFO_BUFFERING_END:
                            LogUtil.i(TAG, "onInfo MediaPlayer.MEDIA_INFO_BUFFERING_END");
                            if (videoViewCallback != null) {
