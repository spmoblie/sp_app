...
public class OrderEntity extends BaseEntity {
	...
	public String getPriceBonusName() {
		return priceBonusName;
	}


	public void setPriceBonusName(String priceBonusName) {
		this.priceBonusName = priceBonusName;
	}
	...
	public void setPriceBonus(String priceBonus) {
