...
public class WXUserInfoEntity {
	...
	private String headUrl;//	用户头像，最后一个数值代表正方形头像大小（有0、46、64、96、132数值可选，0代表640*640正方形头像），用户没有头像时该项为空
	...
	public WXUserInfoEntity( String openid,
			...
			String country, String headUrl, String privilege, String unionid, String language) {
		super();
