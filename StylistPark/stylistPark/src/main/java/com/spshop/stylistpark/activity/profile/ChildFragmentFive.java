...
public class ChildFragmentFive extends Fragment implements OnClickListener, OnDataListener {
	...
	private RelativeLayout rl_my_wallet, rl_my_bouns, rl_collection, rl_history;
	...
	private void findViewById(View view) {
		...
		tv_bonus = (TextView) view.findViewById(R.id.fragment_five_tv_bonus);
		...
		rl_my_bouns = (RelativeLayout) view.findViewById(R.id.fragment_five_rl_bonus);
	}
	...
	private void initView() {
		...
		rl_my_bouns.setOnClickListener(this);
	}
	...
	private void setView() {
		if (infoEn != null) {
			...
			if (infoEn.getUserRankType() == 4) { //达人展示会员信息
