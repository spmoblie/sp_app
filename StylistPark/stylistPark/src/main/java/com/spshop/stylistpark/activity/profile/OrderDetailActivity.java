...
public class OrderDetailActivity extends BaseActivity implements OnClickListener{
	...
	private TextView tv_total_name, tv_total, tv_fee_name, tv_fee, tv_bonus_name, tv_bonus;
	...
	private void findViewById() {
		...
		tv_bonus_name = (TextView) findViewById(R.id.order_detail_tv_price_bonus_name);
		tv_bonus = (TextView) findViewById(R.id.order_detail_tv_price_bonus);
	...
	private void setView() {
		if (orderEn != null) {
			...
			tv_bonus_name.setText(orderEn.getPriceBonusName() + signStr);
