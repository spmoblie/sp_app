...
public class MainServiceImpl implements MainService {
	...
	public GoodsCartEntity postDeleteGoods(int recId) throws Exception {
		String uri = AppConfig.URL_COMMON_INDEX_URL + "?app=delete_cart";
		List<MyNameValuePair> params = new ArrayList<MyNameValuePair>();
	...
	public GoodsCartEntity postChangeGoods(int recId, int cartNum, int goodsId) throws Exception {
		String uri = AppConfig.URL_COMMON_INDEX_URL + "?app=update_cart";
		List<MyNameValuePair> params = new ArrayList<MyNameValuePair>();
	...
	public BaseEntity postSelectPayment(int payType) throws Exception {
		String uri = AppConfig.URL_COMMON_INDEX_URL + "?app=update_payment";
		List<MyNameValuePair> params = new ArrayList<MyNameValuePair>();
	...
	@Override
	public OrderEntity postConfirmOrderData(int payTypeCode, int payType, String couponId,
	...
	@Override
	public CouponEntity getCouponLists(int status, int count, int page, String rootStr) throws Exception {
		String uri = "";
		List<MyNameValuePair> params = new ArrayList<MyNameValuePair>();
	...
	@Override
	public BaseEntity postCouponNoData(String couponNo) throws Exception {
	...
	@Override
	public BaseEntity postChooseCoupon(String couponId) throws Exception {
		String uri = AppConfig.URL_COMMON_INDEX_URL + "?app=is_bonus";
		List<MyNameValuePair> params = new ArrayList<MyNameValuePair>();
		params.add(new MyNameValuePair("bonus", couponId));
		HttpEntity entity = HttpUtil.getEntity(uri, params, HttpUtil.METHOD_POST);
		String jsonStr = HttpUtil.getString(entity);
